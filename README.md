<div align="center">
  ...
  <p>
    ...
    <img alt="Version" src="https://img.shields.io/badge/version-2.8.33-22d3ee?style=flat-square">
...
<p align="center">
  <strong>SignalDock v2.8.33 — real application UI with the bundled demo dataset</strong><br>
  <img src="./docs/images/app-screenshot.png" alt="SignalDock v2.8.33 application screenshot showing local log analysis" width="100%" />
</p>
