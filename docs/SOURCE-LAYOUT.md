...
Current feature controllers: `query-library-controller.js`, `baseline-controller.js` and `project-controller.js`. Cross-feature work must be supplied as narrow callbacks rather than direct controller-to-controller calls.
