...
Current feature controllers: `query-library-controller.js`, `baseline-controller.js`, `project-controller.js`, `investigation-controller.js`, `exception-controller.js`, `trace-explorer-controller.js`, `trace-outlier-controller.js`, `service-matrix-controller.js`, `service-heatmap-controller.js`, `case-workspace-controller.js` and `case-checkpoint-controller.js`. Cross-feature work must be supplied as narrow callbacks rather than direct controller-to-controller calls.
