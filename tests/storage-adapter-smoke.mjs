...
for(const badSize of [undefined,null,-1,NaN]){let invalid=false;try{await api.readTextFile({name:'bad',size:badSize,text:async()=>''},1024)}catch{invalid=true}assert(invalid,`invalid file size must be rejected: ${String(badSize)}`);}
