...
for(const file of ['src/analysis/span-events.js','src/core/parser-plugins.js','src/core/parser.js'])vm.runInContext(fs.readFileSync(path.join(root,file),'utf8'),context,{filename:file});
