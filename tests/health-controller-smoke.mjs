...
const partialScope = controllerApi.selectScope([{}, {}], partialIndexes, true);
assert.equal(partialScope.filtered, true);
assert.equal(partialScope.indexes, partialIndexes, "filtered Health scope must reuse the read-only index array");
