...
await self.onmessage({ data: { type: "index", version: 17, entries } });
...
await self.onmessage({ data: { type: "filter", requestId: 71, request: { query: "needle", showUnknown: true, sortMode: "original" } } });
