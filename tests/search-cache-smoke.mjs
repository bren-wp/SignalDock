...
vm.runInThisContext(fs.readFileSync(path.join(root,'search-index.js'),'utf8'),{filename:'search-index.js'});
vm.runInThisContext(fs.readFileSync(path.join(root,'query-engine.js'),'utf8'),{filename:'query-engine.js'});
vm.runInThisContext(fs.readFileSync(path.join(root,'search-cache.js'),'utf8'),{filename:'search-cache.js'});
